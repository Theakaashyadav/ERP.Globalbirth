...
const resultSchema = new mongoose.Schema({
  ...
  totalCalls: { type: Number, default: 0 }, outgoingCalls: { type: Number, default: 0 }, incomingCalls: { type: Number, default: 0 }, missedCalls: { type: Number, default: 0 }, totalDurationSeconds: { type: Number, default: 0 }, receivedAt: Date
}, { _id: false });
