...
import { BarChart3, BellRing, Bug, Database, KeyRound, LogOut, Megaphone, Rocket, Settings2, ShieldCheck, Users, Wifi } from "lucide-react";
import PageHeader from "../../components/PageHeader.jsx";
import { logout } from "../../auth.js";

const dashboards = [
  { title: "Mobile App Feedback", description: "Review employee-reported errors, occurrence details, attempted actions and device context.", path: "/admin/app-feedback", icon: Bug, tone: "orange" },
