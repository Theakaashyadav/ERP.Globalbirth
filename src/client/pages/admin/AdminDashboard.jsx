...
const dashboardGroups = [
  ...
  { title:"Mobile App & Attendance", subtitle:"Employee app controls and office access", items:[
    ...
    { title:"Attendance Wi-Fi Exemptions", description:"Allow selected employees to mark attendance without office Wi-Fi verification.", path:"/admin/attendance-wifi-exemptions", icon:WifiOff, tone:"orange" },
    ...
    <main className="screen adminHubScreen">
      <div className="wide">
        ...
        <section className="adminWelcome panel">
          <div><span className="eyebrow">{dashboardGroups.reduce((count, group) => count + group.items.length, 0)} SECURE MODULES</span><h2>Everything under control</h2><p>Select a workspace to manage your organization.</p></div>
          <BarChart3 size={38} />
        </section>
