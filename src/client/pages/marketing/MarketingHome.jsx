...
const modules = [
  { title: "Employee Alerts", description: "Send marketing notices and important messages to every active employee.", path: "/alerts/manage?sender=marketing", icon: BellRing, tone: "orange", label: "Open alert center" },
  {
    title: "Assign Leads",
    description: "Create leads, see permanent assignments, and review employee ownership.",
...
export default function MarketingHome() {
  ...
  return <main className="screen adminHubScreen"><div className="wide">
    ...
    <p className="adminEmployeeNotice"><Route size={16}/> Each lead stays with its assigned employee.</p>
  </div></main>;
}
