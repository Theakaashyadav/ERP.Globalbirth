...
export default function BroadcastAlerts(){
 const [params]=useSearchParams();const requested=params.get("sender")?.toLowerCase();const senderRole=["admin","hr","marketing"].includes(requested)?requested:"admin";
