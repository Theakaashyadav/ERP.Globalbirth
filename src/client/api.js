...
export const AttendanceApi = {
  ...
  ,getLeadSheetSettings: () => request("getLeadSheetSettings")
  ,updateLeadSheetSettings: (sheetUrl, employeeIds) => request("updateLeadSheetSettings", { sheetUrl, employeeIds })
  ,syncLeadSheet: () => request("syncLeadSheet")
  ...
  ,getAttendanceWifiExemptions: () => request("getAttendanceWifiExemptions")
  ,updateAttendanceWifiExemptions: employeeIds => request("updateAttendanceWifiExemptions", { employeeIds })
  ,getAlertRecipients: () => request("getAlertRecipients")
  ,sendBroadcastAlert: (subject, message, senderRole, audience) => request("sendBroadcastAlert", { subject, message, senderRole, ...audience })
