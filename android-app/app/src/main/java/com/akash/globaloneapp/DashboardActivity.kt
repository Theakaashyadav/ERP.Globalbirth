...
class DashboardActivity : AppCompatActivity() {
    ...
    private fun renderDashboard(session: SessionManager) {
        ...
        if (session.hasMobileFeature("leads")) tiles.add(modernActionCard(R.drawable.ic_dashboard_leads, "Assigned Leads", "Call and update your assigned prospects", "#7C3AED", "#F5F3FF", assignedLeadCount) { startActivity(Intent(this, LeadsActivity::class.java)) })
